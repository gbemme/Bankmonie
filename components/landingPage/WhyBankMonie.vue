    ...
    <div
      ...
      <div class=" md:tw-px-0 tw-px-9 md:tw-mt-0 tw-mt-9">
        ...
        <div class="md:tw-w-22">
          <span class="dark-col md:tw-mt-9 md:tw-text-4xl md:tw-px-1 tw-font-bold tw-text-3xl">Goodbye High Fees - <span
            style="color: #01E068">Keep More of Your Money </span></span>
        </div>
        <p class="tw-mb-10 md:tw-mb-0 md:tw-mt-4 md:tw-w-24.5 md:tw-pr-8 md:tw-text-xl tw-text-base tw-font-normal">We
          We believe that every business owner should have easy access to POS devices without high upfront costs or
          ridiculous fees. That's why our POS devices are affordable with no hidden fees, and no hassle. Also,
    ...
    <div class="md:tw-my-36 tw-mt-80 tw-mb-80 md:tw-mb-0">
      <div
        ...
        <div class="md:tw-px-0 tw-px-8 md:tw-w-20.6 md:tw-mt-0 tw-mt-9">
          <small class="md:tw-text-sm md:tw-font-normal md:tw-flex tw-hidden tw-mb-3">Seamless Onboarding </small>
          <div class="md:tw-w-100">
            <span class="dark-col md:tw-mt-9 md:tw-text-4xl tw-text-3xl tw-font-bold">
              Get Started in 5 Minutes -<span
      ...
      <div
        ...
        <div class="md:tw-px-0 tw-px-9 md:tw-mt-0 tw-mt-9">
          ...
          <div class="md:tw-w-21 md:tw-px-0">
            <span class="dark-col md:tw-text-4xl tw-text-3xl tw-font-bold">Receive <span
              style="color: #01E068">Instant </span>Payments</span>
          </div>
          <p class="md:tw-mt-4 md:tw-text-xl md:tw-w-25 tw-text-base tw-px-1 tw-font-normal">
            One of the main challenges faced by business owners in Nigeria is the long settlement time after making
            sales. With BankMe POS, you can now receive your funds instantly, without any delays. No more waiting
      ...
      <div class="support md:tw-w-4/6 md:tw-m-auto">
        <div class="md:tw-flex md:tw-w-auto md:tw-m-auto md:tw-items-center md:tw-justify-between">
          ...
          <div class="md:tw-w-6/12 md:tw-px-0 tw-px-8 md:tw-mt-0 tw-mt-9">
            ...
            <div class="tw-w-80">
              <span class="dark-col md:tw-mt-5 md:tw-text-4xl tw-text-3xl tw-px-1 tw-font-bold">Excellent <span
