    ...
    <div class="pricing md:tw-w-3/4 md:tw-mx-10 tw-w-full">
      <div class="md:tw-flex md:tw-w-auto md:tw-m-auto md:tw-items-center tw-justify-between tw-block tw-my-12">
        ...
        <div class="md:tw-w-4/12 tw-px-9">
                ...
                <p class="md:tw-mt-9 md:tw-text-xl tw-text-base tw-px-1 tw-font-normal">We gives our agents the best pricing and take fair commission this allows them to compete favourably among
      ...
      <div class="settlement md:tw-w-3/4 md:tw-m-auto">
        <div class="md:tw-flex md:tw-w-auto md:tw-m-auto md:tw-items-center tw-justify-between tw-block">
          ...
          <div class="md:tw-w-4/12 tw-px-9">
            ...
            <p class="md:tw-mt-9 md:tw-text-xl tw-text-base tw-px-1 tw-font-normal">
      ...
      <div class="support md:tw-w-3/4 md:tw-m-auto">
        <div class="md:tw-flex md:tw-w-auto md:tw-m-auto md:tw-items-center tw-justify-between">
          ...
          <div class="md:tw-w-4/12 tw-px-9">
            ...
            <p class="tw-font-normal md:tw-text-lg tw-text-base">As a BankMonie agent, whenever you have an issue you would never be alone.</p>
            <p  class="tw-font-normal md:tw-text-lg tw-text-base">You can call us, Whatsapp us or email us and our support staff will
